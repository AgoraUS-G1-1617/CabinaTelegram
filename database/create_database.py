...
with con:
    ...
    cur.execute("CREATE TABLE IF NOT EXISTS Usuario(Id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,Telegram_id INTEGER)")      #Aquí habrá que poner que la Telegram_id no puede ser nula
